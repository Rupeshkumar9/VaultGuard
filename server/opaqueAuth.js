...
function consumeChallenge(id, expectedKind) {
...
async function createRegistrationResponse({ userIdentifier, registrationRequest, kind, userId, email }) {
...
async function startLogin({ userIdentifier, registrationRecord, startLoginRequest, email }) {
  const serverSetup = await ensureReady();
...
async function finishLogin({ challengeId, finishLoginRequest, email }) {
